...
public class GameSettingsFrame extends JFrame {
    ...
    private JPanel createDifficultyPanel() {
        ...
        // 尝试加载自定义单选按钮图标
        Icon radioUnselectedIcon = loadIcon("/resource/radio_unselected.png");
        Icon radioSelectedIcon = loadIcon("/resource/radio_selected.png");
        ...
        for (int i = 0; i < MapModel.LEVELS.length; i++) {
            ...
            if (radioUnselectedIcon != null && radioSelectedIcon != null) {
                levelButtons[i].setIcon(radioUnselectedIcon);
                levelButtons[i].setSelectedIcon(radioSelectedIcon);
            }
    ...
    private Icon loadIcon(String path) {
        ...
        if (iconUrl != null) {
            ...
            System.err.println("警告: 未找到图标资源 " + path);
            return null;
        }
    }
